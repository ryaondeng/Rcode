...
from rcode.core.bus.envelope import JsonRpcError, JsonRpcSuccess
from rcode.core.config import RcodeConfig


def cmd_ping(config: RcodeConfig) -> None:
    try:
...
async def _ping(config: RcodeConfig) -> None:
    t0 = time.monotonic()
    ...
    req = {
        ...
        "id": "cli-1",
        "method": "core.ping",
        "params": {"client": f"cli/{rcode.__version__}"},
    }
